...
export default function PersonalChecklistDetailPage() {
    ...
    <div className="app-container min-h-screen bg-[#fdf7f2] page-content">
      ...
      <div className="px-5 pt-14 pb-2 animate-fade-in-up">
        <button
          ...
          className="flex items-center gap-1.5 text-sm font-medium text-[#b7c6c2] hover:text-[#171e19] transition-colors mb-3"
        >
          <ChevronRight size={16} className="rotate-180" /> Back to space
        </button>
        ...
        >
          ...
          {checklist.totalTasks > 0 && (
            <div className="mt-3 flex items-center gap-3">
              <div className="flex-1 h-2.5 rounded-full bg-[#b7c6c2]/20 overflow-hidden">
                <div className="h-full rounded-full bg-[#10B981] transition-all duration-500" style={{ width: `${pct}%` }} />
              </div>
              <span className="text-[11px] font-bold text-[#10B981]">{pct}%</span>
            </div>
          )}
          ...
          <div className="mt-3 px-3 py-1.5 rounded-xl bg-[#b7c6c2]/10 inline-flex items-center gap-1.5">
            ...
            <span className="text-[10px] font-bold text-[#b7c6c2] uppercase tracking-[0.08em]">No points — personal space</span>
          </div>
        </div>
      </div>
      ...
      <div className="px-5 mt-3 space-y-2.5">
            ...
            >
              <div className="p-3.5 flex items-center gap-3">
                <button
                  ...
                  className="shrink-0 w-9 h-9 rounded-full border-2 border-[#b7c6c2]/30 text-transparent hover:border-[#10B981] hover:bg-green-50 flex items-center justify-center transition-all duration-300 active:scale-90"
                >
                ...
                <button
                  ...
                  className="p-2 rounded-full bg-[#eeebe3] text-[#95a5a0] hover:text-[#10B981] hover:bg-green-50 transition-all active:scale-90"
                >
                  <Pencil size={14} />
                </button>
              </div>
                ...
                >
                  <div className="p-3.5 flex items-center gap-3">
                    <button
                      ...
                      className="shrink-0 w-9 h-9 rounded-full bg-[#10B981] border-2 border-[#10B981] text-white flex items-center justify-center transition-all duration-300 active:scale-90"
                    >
                      <Check size={16} strokeWidth={3} />
                    </button>
                    <div className="flex-1 min-w-0">
        ...
        <div className="flex items-center gap-2 pt-2">
          <Input
            ...
            className="flex-1 h-11 rounded-xl bg-white border-[#b7c6c2]/20 text-sm focus:border-[#10B981] focus:ring-[#10B981]"
            onKeyDown={(e) => {
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <button
                ...
                className="shrink-0 w-11 h-11 rounded-xl bg-[#ca0013] text-white flex items-center justify-center disabled:bg-[#eeebe3] disabled:text-[#b7c6c2] transition-all active:scale-90 shadow-[0_4px_12px_-2px_rgba(202,0,19,0.3)]"
                aria-label="Add task"
              >
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  >
                    {clForm.bgColor === c && <Check size={14} className="text-[#10B981] mx-auto" />}
                  </button>
                ))}
              </div>
            </div>
        ...
        <div className="fixed inset-0 z-[60] bg-black/40 backdrop-blur-sm flex items-end justify-center" onClick={closeFlagManager}>
          <div className="bg-white rounded-t-[2.5rem] w-full max-w-[480px] p-6 pb-32 animate-slide-up max-h-[80vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="space-y-3">
              <div>
                <label className="section-header block mb-2">Name</label>
                <Input value={flagForm.name} onChange={(e) => setFlagForm((f) => ({ ...f, name: e.target.value }))} placeholder="e.g. Urgent" className="rounded-xl bg-[#eeebe3] border-[#b7c6c2]/20 focus:border-[#10B981] focus:ring-[#10B981]" />
              </div>
              <div>
      ...
      {open && (
        <div className="absolute z-[300] mt-1 left-0 right-0 bg-white rounded-[1.25rem] border border-[#b7c6c2]/20 shadow-[0_12px_40px_-12px_rgba(0,0,0,0.18)] p-1.5 max-h-60 overflow-y-auto animate-fade-in-up">
          ...
          <div className="border-t border-[#b7c6c2]/20 mt-1 pt-1">
            <button type="button" onClick={() => { setOpen(false); onCreate(); }} className="w-full flex items-center gap-2 px-3 py-2 rounded-xl text-sm font-semibold text-[#10B981] hover:bg-green-50 transition-colors">
