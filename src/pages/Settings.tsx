    ...
    return (
        <div className="app-container min-h-screen bg-[#fdf7f2] page-content">
            ...
            <div className="px-5 pt-14 pb-4 animate-fade-in-up">
                <h1 className="text-3xl font-semibold text-[#171e19] tracking-tight">Settings
                                                </h1>
                <p className="text-sm text-[#b7c6c2] font-medium mt-1">Manage your household
                                                </p>
            </div>
            {}
            ...
            <div className="px-5 mb-4">
                <div
                    className="bg-white rounded-[1.5rem] p-5 border border-[#b7c6c2]/20 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.04)]">
                    <h3 className="text-sm font-semibold text-[#171e19] mb-2">
                    </h3>
                    <p className="text-sm text-[#b7c6c2] font-medium leading-relaxed">
                    </p>
                    <div
                        className="flex items-center gap-2 mt-3 text-xs text-[#b7c6c2] font-medium">
                        <span className="px-2.5 py-1 bg-[#FFF1E6] rounded-full text-cantaloupe">v1.0
                                                                    </span>
            ...
            <Dialog open={showDialog} onOpenChange={setShowDialog}>
                <DialogContent
                    className="rounded-[2rem] max-w-[380px] mx-auto p-0 gap-0 border-[#b7c6c2]/20">
                    ...
                    <div className="px-6 pb-6 space-y-4">
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-2 mt-2">
                                {EMOJIS.map(emoji => (<button
                                    ...
                                    className={`w-10 h-10 rounded-xl flex items-center justify-center text-lg transition-all active:scale-90 ${newEmoji === emoji ? "bg-[#FFF1E6] ring-2 ring-cantaloupe scale-110" : "bg-[#eeebe3] hover:bg-[#b7c6c2]/20"}`}>
                                    {emoji}
                                </button>))}
                            </div>
                        </div>
                        <div>
                            ...
                            <div className="flex flex-wrap gap-2 mt-2">
                                {USER_COLORS.map(color => (<button
                                    key={color}
                                    onClick={() => setNewColor(color)}
                                    className={`w-9 h-9 rounded-full transition-all active:scale-90 ${newColor === color ? "ring-2 ring-offset-2 ring-[#171e19] scale-110" : "hover:scale-105"}`}
                                    style={{
