                    ...
                    <Dialog open={showNewDialog} onOpenChange={setShowNewDialog}>
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <DialogTrigger asChild>
                                    <button
                                        className="shrink-0 w-10 h-10 rounded-full bg-cantaloupe text-white flex items-center justify-center shadow-md hover:shadow-lg transition-all active:scale-90">
                                        <Plus size={20} />
                                    </button>
                                </DialogTrigger>
                            </TooltipTrigger>
