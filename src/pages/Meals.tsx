...
import { ArrowLeft, Croissant, Sparkles } from 'lucide-react';
    ...
    <div className="app-container min-h-screen bg-[#fdf7f2] page-content">
      ...
      <div className="px-5 pt-14 pb-4 animate-fade-in-up">
        ...
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 rounded-2xl bg-[#FDA172]/15 flex items-center justify-center">
            <Croissant size={24} className="text-[#FDA172]" />
          </div>
          <div>
            <h1 className="text-3xl font-semibold text-[#171e19] tracking-tight">Meals</h1>
            <p className="text-sm text-[#b7c6c2] font-medium">Plan & track meals</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-5 pt-12 pb-8 flex flex-col items-center text-center">
        <div className="w-24 h-24 rounded-full bg-[#FDA172]/10 flex items-center justify-center mb-5">
          <Sparkles size={36} className="text-[#FDA172]" />
        </div>
        ...
        <p className="text-sm text-[#b7c6c2] max-w-xs leading-relaxed">
          Meal planning and tracking will be available here. Stay tuned!
        </p>
      </div>
