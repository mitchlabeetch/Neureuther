                ...
                <svg width={svgSize} height={svgSize} className="drop-shadow-xl mt-3">
                    <g
                        style={{
                            ...
                            transition: spinning ? "transform 3.5s cubic-bezier(0.17, 0.67, 0.12, 0.99)" : "transform 0.6s cubic-bezier(0.34, 1.56, 0.64, 1)"
                        }}>
                        {segments.map((seg, i) => {
                    ...
                    <g
                        ...
                        <circle
                            ...
                            stroke="#2D2B2A"
                            strokeWidth={3} />
                        <circle cx={center} cy={center} r={26} fill="#FDA172" />
                        <text
                            x={center}
                            y={center + 1}
                            textAnchor="middle"
